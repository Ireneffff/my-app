                ...
                return (
                  <li key={trade.id}>
                    ...
                    >
                      {trade.isPaperTrade ? (
                        <span
                          className="pointer-events-none absolute bottom-3 left-4 inline-flex items-center rounded-full border border-[#D1D5DB]/80 bg-[#F5F5F5]/90 px-2.5 py-1 text-[0.58rem] font-semibold uppercase tracking-[0.24em] text-[#4B5563] md:hidden"
                        >
                          Paper trade
                        </span>
                      ) : null}
                      ...
                      <div className="hidden w-full items-center gap-5 md:flex">
                        ...
                        <div className="ml-auto flex items-center gap-3">
                          {trade.isPaperTrade ? (
                            <span className="hidden md:inline-flex items-center rounded-full border border-[#D1D5DB]/80 bg-[#F5F5F5]/90 px-2.5 py-1 text-[0.58rem] font-semibold uppercase tracking-[0.24em] text-[#4B5563]">
                              Paper trade
                            </span>
                          ) : null}
                          <time
