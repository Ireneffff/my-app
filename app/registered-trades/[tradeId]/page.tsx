...
export default function RegisteredTradePage() {
  ...
  const [panelTransitionStage, setPanelTransitionStage] = useState<
  ...
  useEffect(() => {
    ...
    setPanelTransitionStage("enter-start");
    const animationFrame = window.requestAnimationFrame(() => {
      setPanelTransitionStage("enter-end");
    });
            ...
            <div className="mx-auto w-full max-w-4xl">
              <div className="grid w-full grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2">
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="sticky top-1/2 z-30 flex h-9 w-9 -translate-y-1/2 justify-self-end items-center justify-center rounded-full border border-border/80 bg-[color:rgb(var(--surface)/0.94)] p-0 text-muted-fg shadow-[0_8px_20px_rgba(15,23,42,0.08)] backdrop-blur hover:text-fg focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:rgba(99,102,241,0.35)] disabled:border-border/60 disabled:text-muted-fg/60 sm:h-10 sm:w-10 md:h-11 md:w-11"
                ...
                <div
                  className={`relative transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                    panelTransitionStage === "enter-start"
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="sticky top-1/2 z-30 flex h-9 w-9 -translate-y-1/2 justify-self-start items-center justify-center rounded-full border border-border/80 bg-[color:rgb(var(--surface)/0.94)] p-0 text-muted-fg shadow-[0_8px_20px_rgba(15,23,42,0.08)] backdrop-blur hover:text-fg focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:rgba(99,102,241,0.35)] disabled:border-border/60 disabled:text-muted-fg/60 sm:h-10 sm:w-10 md:h-11 md:w-11"
