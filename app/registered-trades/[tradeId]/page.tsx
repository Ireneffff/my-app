            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_minmax(0,18rem)] md:gap-2">
                    ...
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_minmax(0,18rem)] md:gap-2 md:items-end">
                      <div className="rounded-2xl border border-border bg-surface px-4 py-3">
