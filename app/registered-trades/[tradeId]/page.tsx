            ...
            <div className="mx-auto w-full max-w-3xl sm:max-w-4xl">
              <div className="grid w-full grid-cols-[auto_minmax(0,1fr)_auto] items-start gap-2 sm:gap-3 md:gap-4">
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="sticky top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border-none bg-[rgba(255,255,255,0.6)] p-0 text-slate-900 shadow-none backdrop-blur-sm transition-colors duration-200 ease-out hover:bg-[rgba(255,255,255,1)] hover:shadow-none hover:translate-y-0 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:rgba(99,102,241,0.35)] active:scale-100 justify-self-end -mr-3 md:-mr-6"
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="sticky top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border-none bg-[rgba(255,255,255,0.6)] p-0 text-slate-900 shadow-none backdrop-blur-sm transition-colors duration-200 ease-out hover:bg-[rgba(255,255,255,1)] hover:shadow-none hover:translate-y-0 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[color:rgba(99,102,241,0.35)] active:scale-100 justify-self-start -ml-3 md:-ml-6"
