...
export function LibrarySection({
  ...
  return (
    <div className="flex w-full flex-col items-center gap-12">
      <div className="w-full rounded-[40px] border border-[#E6E6E6] bg-white px-4 py-12 text-center shadow-[0_32px_80px_-60px_rgba(15,23,42,0.25)] sm:px-6">
      ...
      {errorMessage ? (
        <p className="w-full max-w-[1180px] rounded-2xl bg-red-50 px-4 py-3 text-xs font-medium text-red-600">
          {errorMessage}
        </p>
      ) : null}
    </div>
