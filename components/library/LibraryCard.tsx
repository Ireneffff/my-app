...
export function LibraryCard({
  ...
  const baseVisualWrapperClassName =
    "flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-b from-white via-white to-[#f5f7fb] ring-1 ring-neutral-200/80 transition-all duration-400";
