  ...
  return (
    <div className={className ? `relative ${className}` : "relative"}>
      <button
        ...
        className="inline-flex h-8 w-full cursor-pointer items-center justify-between gap-2 rounded-full border border-gray-300 bg-white/60 px-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600 transition-colors duration-200 ease-out hover:bg-blue-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[rgb(var(--surface))] sm:w-auto"
      ...
      <div
        ...
        className={`absolute right-0 z-30 mt-2 w-full max-w-[calc(100vw-2rem)] rounded-2xl border border-gray-200 bg-white/95 p-1 shadow-[0_12px_30px_rgba(15,23,42,0.12)] backdrop-blur-sm transition-all duration-200 ease-out sm:w-56 ${
          isOpen
